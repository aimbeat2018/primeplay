...
package ott.primeplay.models.home_content;
...
import ott.primeplay.database.homeContent.converters.CountryConverter;
import ott.primeplay.database.homeContent.converters.FeaturedTvConverter;
import ott.primeplay.database.homeContent.converters.FeaturesGenreConverter;
import ott.primeplay.database.homeContent.converters.GenreConverter;
import ott.primeplay.database.homeContent.converters.GoldConverter;
import ott.primeplay.database.homeContent.converters.LatestMovieConverter;
import ott.primeplay.database.homeContent.converters.PopularMovieConverter;
import ott.primeplay.database.homeContent.converters.PopularStarsConverter;
import ott.primeplay.database.homeContent.converters.SliderTypeConverter;
import ott.primeplay.database.homeContent.converters.TvSeriesConverter;
